...
const MentorCard = ({ ...mentorsInfo }: MentorsInfoProps) => {
  ...
  return (
    <div className="md:h-[264px] w-[550px] md:w-[850px] lg:w-[1011px] p-[28px] bg-white shadow-md rounded-[20px] flex">
      <div className="md:h-[218px] w-[180px] flex flex-col justify-start md:justify-between items-center">
        ...
        <Link href="">
          <Button className="mt-[25px] md:m-1  text-[14px]" variant="secondary">View Profile</Button>
        </Link>
      </div>
      ...
      <div className="md:h-[180px] w-full font-mainFont pl-3">
        ...
        <div className=" h-full flex flex-col md:flex-row w-full items-start justify-start">
          <div>
            ...
            <div className="text-xs leading-4 pt-[6px] overflow-hidden h-14 w-[300px] lg:w-[405px]">{aboutMentor}</div>
          </div>
