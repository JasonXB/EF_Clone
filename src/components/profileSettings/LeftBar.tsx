...
const LeftBar: NextPage = ({}) => {
  ...
  return (
    <div className="flex ">
      <ul className="bg-gray-300 bg-opacity-20 border-gray-200 w-72 text-gray-900 -ml-8 -mt-8 -mb-8 pt-7 h-full ">
        {nav.map((section) => {
          return (
...

{
  /* <li className="px-6 py-3 w-10/12 bg-white rounded-2xl ml-5 mb-5 text-base hover:shadow-lg">
            ...
            <li className="px-6 py-3 w-10/12 bg-white rounded-2xl ml-5 text-base hover:shadow-lg">
            <div className="pl-3 hover:border-l-4 hover:border-pink-600 hover:pl-2 text-md">
              <a href="#">Password</a>
              </div>
            </li> */
