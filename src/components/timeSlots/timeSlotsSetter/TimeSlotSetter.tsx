...
const TimeSlotSetter = ({ meeting, meetingType, index }: TimeSlotSetterProps) => {
    const { removeFromExistingTimes, removeFromNewTimes } = useContext(ScheduleModalContext);
    ...
    return (
        <div className="flex flex-row">
            {/* start time */}
            <TimeTextField meeting={meeting} meetingType={meetingType} whichTime={"start"} index={index}/>
            {/* dash icon */}
            ...
            {/* end time */}
            <TimeTextField meeting={meeting} meetingType={meetingType} whichTime={"end"} index={index}/>
            {/* delete button */}
