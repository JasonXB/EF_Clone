...
const TimeSlotSetter = ({ meeting, isTimeNull }: TimeSlotSetterProps) => {
    ...
    return (
        <div className="flex-auto flex">
            ...
            {/* delete button */}
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 ml-5 mt-3">
