...
const MentorProfileTop = ({
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center md:items-start lg:items-start lg:flex-row xl:flex-row">
        <div className="flex flex-col items-center w-3/5 md:items-center lg:items-center xl:items-start md:w-3/5 lg:w-4/5 xl:w-2/5">
          ...
          <Button className="px-8 mt-6 mb-6 text-xl w-3/8 xl:ml-14">Request</Button>
        </div>

        {/* Right: Name, location etc */}
        <div className="w-full px-10 py-5 mt-4 xl:px-0 xl:w-3/5 h-3/5">
          {/* Mentor name */}
          <h1 className="mb-6 text-5xl font-bold text-black xl:text-5xl lg:mb-2 xl:mb-2">
            {name}
          </h1>
