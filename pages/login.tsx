...
const login: NextPage = ({}) => {
  ...
  return (
    <div>
      ...
      <div className="outer font-mainFont border-[#B9C0D3] bg-white border-t border-r rounded-5 pt-[75px]">
                ...
                <div className="right-inside w-1/2">
                  ...
                  <form 
                    ...
                    <div className="py-6">
                      <button 
                        type='submit'
                        className="text-white bg-[#D8286D] text-[20px] font-semibold rounded-[25px] h-[60px] w-[146px]">
                        Login
                      </button>
                      {/* <button 
                        type='submit'
                        className="text-white bg-[#D8286D] text-[20px] font-semibold rounded-[25px] h-[60px] w-[146px] ml-[20px]">
                        Sign up
                      </button> */}
                    </div>
